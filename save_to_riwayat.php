...
$price = $_POST['price'];
$kendaraan = "motor"; // kendaraan yang digunakan
...
if ($result_check->num_rows > 0) {
    ...
    $sql_update = "UPDATE pemesanan SET distance='$distance', price='$price', kendaraan='$kendaraan' WHERE id='$id'";
    ...
    $sql_insert = "INSERT INTO pemesanan (address, address_b, latitude, longitude, latitude_b, longitude_b, distance, price, kendaraan) 
                    VALUES ('$address', '$address_b', '$latitude', '$longitude', '$latitude_b', '$longitude_b', '$distance', '$price', '$kendaraan')";
